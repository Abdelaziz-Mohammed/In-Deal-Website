...
export default function RegisterProgress({ step }: { step: number }) {
  ...
  return (
    <div className="flex flex-col items-center mb-6 gap-4">
      <h3 className="text-black text-xl font-semibold">{t("progress.title")}</h3>
      <div className="grid grid-cols-3 gap-5 w-3/5">
      ...
      <p className="text-[13px] text-light-gray text-center">{t("progress.step_of", { step })}</p>
    </div>
  );
}
